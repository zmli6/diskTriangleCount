...
int main(){
    ...
    for(int i = 0; i < 1; i++){
        ...
        dataset.companionFilePath = "diskTC/" + dataName[i] + "/companyFile/";
        dataset.newEdgeFile = "diskTC/" + dataName[i] + "/newGraph/newEdge.dat";
        dataset.newEdgeFileBackup = "diskTC/" + dataName[i] + "/newGraph/newEdgeBackup.dat";
        dataset.partitionDir = "diskTC/" + dataName[i] + "/PartitionFile/";
        dataset.dataPath = "diskTC/dataSet/" + dataName[i] + ".txt";
        dataset.tempSortFilePrefix = "diskTC/" + dataName[i] + "/SortFile/";
        string timeRecord = "diskTC/timeRecord/" + dataName[i] + ".txt";
        dataset.bitsetRecord = "diskTC/" + dataName[i] + "/BitSet/";
        ...
        dataset.log.setFilePath("diskTC/" + dataName[i]);
